...
%accompany meta code.  The function also computes the background scatter
%density to make sure it will provide accurate results.  The minimal
%requirement is 30 scatters per cubic wavelength
