...
for ii=1:totalBandsPerRectusFemoris
    phantomData.rectusFemoris.band(ii).x_m=sXX_m(:,ii);
    phantomData.rectusFemoris.band(ii).y_m=(rand (size(sXX_m,1),1)-0.5)*4/1000;
    %phantomData.rectusFemoris.band(ii).z_m=szz_m(:)+((ii-5)/4)/1000-1.1174/1000;
    phantomData.rectusFemoris.band(ii).z_m=sZZ_m(:,ii);
    phantomData.rectusFemoris.band(ii).amplitude=15*ones(size(sXX_m,1),1);
...
chkDistTopx=[phantomData.rectusFemoris.band(1).x_m(1:end-1).';phantomData.rectusFemoris.band(1).x_m(2:end).'];
chkDistTopz=[phantomData.rectusFemoris.band(1).z_m(1:end-1).';phantomData.rectusFemoris.band(1).z_m(2:end).'];
chkDistBottomx=[phantomData.rectusFemoris.band(end).x_m(1:end-1).';phantomData.rectusFemoris.band(end).x_m(2:end).'];
chkDistBottomz=[phantomData.rectusFemoris.band(end).z_m(1:end-1).';phantomData.rectusFemoris.band(end).z_m(2:end).'];
