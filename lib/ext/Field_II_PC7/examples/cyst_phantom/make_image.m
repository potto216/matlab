...
%%
figure
imagesc(((1:(no_lines-1))*d_x-no_lines*d_x/2)*1000,((1:n)/fn+min_sample/fs)*1540/2*1000,env)
...
%%
figure
image(((1:(no_lines-1))*d_x-no_lines*d_x/2)*1000,((1:n)/fn+min_sample/fs)*1540/2*1000,log_env)
xlabel('Lateral distance [mm]')
ylabel('Axial distance [mm]')
colormap(gray(127))
axis('image')
axis([-20 20 35 90])
title('Preinterpolation')
end
