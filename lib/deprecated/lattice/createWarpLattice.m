...
%the data and metadata in dataFilename.  The data is the square root of the 
%absolute value of the complex data.
%
...
function [lattice,dataFilename]=createWarpLattice(caseFile,samplePoints_rc,varargin)
